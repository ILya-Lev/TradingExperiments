...
public class SolverTests(ITestOutputHelper output)
{
    ...
    public void Solve_Extreme004_Solved()
    {
        var digits = new int[][]
        {
            new []{4,0,0,0,1,0,9,6,0},
            new []{9,0,0,0,0,5,0,2,0},
            new []{6,0,0,0,0,3,0,0,0},
            
            new []{0,0,2,0,3,0,0,0,8},
            new []{0,0,0,0,0,0,3,0,6},
            new []{0,0,7,0,0,8,0,1,0},
            
            new []{0,0,5,0,0,1,0,9,0},
            new []{2,0,0,4,0,0,0,8,0},
